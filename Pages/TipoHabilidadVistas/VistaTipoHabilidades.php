...
<head>
    ...
    <title>Tipos de habilidades</title>
    <style>
        table
        {
...
<body>
    ...
    <table>
        <tr>
            ...
            <td class="b"><a href="./VistaCrearTipoHabilidad.php">Crear</a></td>
        </tr>
        <?php  
        $fila = "a";
        ...
        ?>
            <tr>
                <td class="<?php echo $fila; ?>"><?=$tipo_habilidad['tipo']?></td>
                <td class="<?php echo $fila; ?>">
                    <a href=".\VistaEditarTipoHabilidad.php?id=<?=$tipo_habilidad['id']?>">Editar</a>
                    <a href="..\..\TipoHabilidad\DeleteTipoHabilidad.php?id=<?=$tipo_habilidad['id']?>">Borrar</a>
                </td>
            </tr>
        <?php
            if($fila == "a")
    ...
    <?php
        ...
        {
            ?><a href='VistaTipoHabilidades.php?&page=<?php echo $i; ?>' ><?php echo $i; ?></a><?php
        }
